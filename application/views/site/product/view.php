							...
							<ul id="thumblist" >
							    ...
							    <?php if (is_array($image_list)): ?>
							    	<?php foreach ($image_list as $img): ?>
							    		<li>
										    <a class="" href='javascript:void(0);' rel="{gallery: 'gal1', smallimage: '<?php echo base_url('upload/product/' . $img); ?>',largeimage: '<?php echo base_url('upload/product/' . $img); ?>'}">
		               ...
		               <p class='option'>
		               		...
		               		<?php if ($product->discount > 0) { ?>
				                <?php 
				                  ...
				                  <span class='product_price'><?php echo number_format($price_new); ?> đ</span><span class="price_old"><?php echo number_format($product->price); ?> đ</span>
				              <?php } else { ?>
