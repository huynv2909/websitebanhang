				...
				<tr>
					<td colspan="6">
					 	<div class="list_action itemActions">
							<a href="#submit" id="submit" class="button blueB" url="<?php echo admin_url('news/del_all'); ?>">
				...
				<?php foreach ($list as $row): ?>
		       	<tr class='row_<?php echo $row->id; ?>'>
					...
					<td class="option textC">
						<a  href="<?php echo admin_url('news/view/') . $row->id; ?>" target='_blank' class='tipS' title="Xem chi tiết bài viết">
