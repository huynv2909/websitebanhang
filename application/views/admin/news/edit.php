				...
				<div class="tab_container">
			     	<div id='tab1' class="tab_content pd0">
			         	<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo"><input name="title" id="param_title" _autocheck="true" type="text" value="<?php echo $news->title; ?>" /></span>
						...
						<div class="formRow">
							...
							<div class="formRight">
								<div class="left">
									...
									<img src="<?php echo base_url('upload/news/') . $news->image_link; ?>" alt="" style="width: 100px; height: 70px;">
